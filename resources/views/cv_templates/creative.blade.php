...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* ĐÃ SỬA: Chuyển căn lề từ justify sang left để tránh lỗi giãn chữ tạo khoảng trắng */
        .text-left {
            text-align: left;
        }
        ...
        <tr class="main-row">
            <td class="sidebar-cell">
                ...
                <div class="avatar-box">
                    <div class="avatar-circle">
                        <img src="{{ !empty($candidate->avatar_pdf_path) ? $candidate->avatar_pdf_path : asset($candidate->avatar_url) }}" />
                    </div>
                ...
                <div class="text-left" style="font-size: 12px; color: #cbd5e1; line-height: 1.5; margin-bottom: 8px;">
                    {{ $candidate->summary }}
                </div>
                            ...
                            @if(is_array($references))
                                @if(isset($references[0]) && is_array($references[0]))
                                    @foreach($references as $ref)
                                        <div style="margin-bottom: 8px; font-size: 12px; line-height: 1.4;">
                                            ...
                                            @if(isset($ref['relationship'])) <br><span style="color: #38bdf8; font-style: italic;">{{ $ref['relationship'] }}</span> @endif
                                ...
                                @else
                                    <div style="font-size: 12px; line-height: 1.4;">
                                        ...
                                        @if(isset($references['relationship'])) <br><span style="color: #38bdf8; font-style: italic;">{{ $references['relationship'] }}</span> @endif
            ...
            <td class="content-cell">
                ...
                @if($candidate->objective)
					...
					<div style="font-size: 13px; color: #334155; padding-left: 15px; border-left: 2px solid #3b82f6; margin-left: 5px; text-align: left; line-height: 1.4;" class="whitespace-pre-line break-words">{{ $candidate->objective }}</div>
                @endif

                <div class="main-section-title" style="{{ $candidate->objective ? '' : 'margin-top: 0;' }}">Kinh nghiệm làm việc & Dự án</div>
                            ...
                            <div class="project-item">
                                <table class="table-fluid" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="project-duration">{{ $proj['duration'] ?? '' }} tháng</td>
                                    </tr>
                                </table>
                                ...
                                @if(isset($proj['description']))
                                    <p class="project-desc whitespace-pre-line break-words text-left" style="line-height: 1.4;">
                                        {{ $proj['description'] }}</p>
                                @endif
                            </div>
                        @endforeach
                ...
                <div class="main-section-title" style="margin-bottom: 2px;">Học vấn & Bằng cấp</div>
<div style="font-size: 13px; color: #334155; padding-left: 15px; border-left: 2px solid #cbd5e1; margin-left: 5px; text-align: left; line-height: 1.3;" class="break-words">{!! nl2br(e($candidate->education)) !!}</div>
